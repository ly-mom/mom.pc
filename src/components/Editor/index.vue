...
export default {
  ...
  data() {
    return {
      uploadUrl: process.env.VUE_APP_BASE_API + '/Base/File/UploadByForm?path=notify', // 上传的图片服务器地址
      headers: {
  ...
  methods: {
    ...
    handleUploadSuccess(res, file) {
      ...
      if (res.Success) {
        ...
        // 裁切端口加上固定的访问端口
        const urlPrefix = process.env.VUE_APP_DOWNLOAD_API
        ...
        //              url: urlPrefix + res.Data.Files[0].Urls,
        //         })
        // 调整光标到最后
