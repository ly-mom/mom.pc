<template>
  <div class="noticeMain wrap">
    <div class="sectionRight">
      <div class="boxTitleLeft">视频播放</div>
      ...
      <div>
        <video :src="detailData.Url" :poster="detailData.Cover ? detailData.Cover : ''" controls width="800px" height="600px" loop></video>
        <div class="mt10">{{ detailData.Description }}</div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async getVideo(Id) {
      ...
      if (res.Success) {
        this.detailData = res.Data.PageList[0] || {}
      } else {
        this.msgError(res.Msg)
      }
    },
